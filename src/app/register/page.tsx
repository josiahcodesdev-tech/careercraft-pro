...
export default function RegisterPage() {
  ...
  const { register, loginWithGoogle } = useClientAuth();
      ...
      <div className="max-w-[420px] mx-auto">
        <div className="bg-card border border-border rounded-2xl p-10">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 h-11 rounded-lg border border-border bg-background hover:bg-card transition-colors text-sm font-medium"
          >
